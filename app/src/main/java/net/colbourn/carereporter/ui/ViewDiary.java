...
import net.colbourn.carereporter.plugins.LocalDatabase.JSONEventTypeProvider;
import net.colbourn.carereporter.plugins.LocalDatabase.LocalDatabaseEventProvider;
import net.colbourn.carereporter.utils.ImageUtils;
